    ...
    <Card>
        <CommentContainer>
            <Comment>
                ...
                <CommentText><span>{commentData.comment}</span><a className='reply-text'>Reply</a></CommentText>
            </Comment>
            {replys?
                replys.map((item)=>(
                    <Commentreply>
                        <Comment>
                            <TopContainer>
                                ...
                                <ProfileContainer>
                                    <ProfileImageContainer>
                                        <ProfileImage src={item.reply_profile_picture}/>
                                    </ProfileImageContainer>
                                    <ProfileName>{item.reply_profile_name}</ProfileName>
